 ...
 *
 * AFS-008 Fix: Bu dosya backend/scripts/jops/ dizinindeydi (typo).
 * app.js require('./jobs/reputationDecay') ile import ediyordu — path uyumsuzluğu
 * nedeniyle sunucu crash ediyordu. Doğru dizin: backend/scripts/jobs/
 *
 * AFS-014 Not: Bu görev, RELAYER_PRIVATE_KEY kullanarak on-chain transaction gönderir.
 * Bu, "Zero Private Key Backend" felsefesiyle kısmen çelişir.
 * Ancak relayer cüzdanı SADECE decayReputation çağırabilir (ABI sınırlı).
 * Kontrat üzerinde fon hareketi veya state değişikliği yapamaz.
